...
const About = () => {
  return (
    <>
      <div style={{maxWidth: '700px', margin: '2rem auto', padding: '2rem 1.5rem', background: '#364156', borderRadius: '1.5rem', boxShadow: '0 4px 24px rgba(0,0,0,0.08)', border: '1px solid #364156'}}>
        <div className="section-title" style={{color: '#FFE066', marginBottom: '2rem', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '0.5rem'}}>
          <Info color="#FFE066" size={32} /> عن الشركة
        </div>
        <div className="section-content" style={{marginBottom: '2rem', lineHeight: '2', fontSize: '1.1rem', color: '#d66853'}}>
          <p>
            <b>ونش انقاذ عمرو بحر</b> –   لإنقاذ ورفع السيارات تعمل في السوق المصري منذ عام <b>2001</b> بمجال انقاذ ورفع السيارات علي الطرق السريعة بكافة أنحاء الجمهورية. لبناء جسور من الثقة المتبادلة بين الشركة وعملائها، ولدينا احدث اوناش ومجهزة باحدث الات رفع السيارات ولدينا فريق عمل محترف جدا، ما يميزنا عن غيرنا هو تقديم خدمة انقاذ سيارات بأعلى جودة وأحدث الاجهزة بأقل سعر و باحترافية عالية.
          </p>
        </div>
        <div className="section-content" style={{marginBottom: '2rem', lineHeight: '2'}}>
          <div style={{display: 'flex', alignItems: 'center', gap: '0.5rem', color: '#FFE066', fontWeight: 'bold', fontSize: '1.2rem', marginBottom: '0.5rem'}}>
            <MessageCircle color="#FFE066" size={24} /> رسالتنا :
          </div>
        ...
        <div className="section-content" style={{marginBottom: '2rem', lineHeight: '2'}}>
          <div style={{display: 'flex', alignItems: 'center', gap: '0.5rem', color: '#FFE066', fontWeight: 'bold', fontSize: '1.2rem', marginBottom: '0.5rem'}}>
            <Star color="#FFE066" size={24} /> اهم ما يميزنا :
          </div>
          <ul style={{listStyle: 'disc', paddingRight: '2rem', marginTop: '1rem', color: '#FFF', fontSize: '1.08rem'}}>
