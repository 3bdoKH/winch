...
export const areas = [
  ...
  'جمال عبدالناصر', 'محور ٣٠ يونيو', 'الهضبه الوسطى', 'كورنيش المقطم', 'وسط البلد',
  ...
  // الإسكندرية
  'الإسكندرية', 'كوم الدكة', 'الشاطبي', 'الأنفوشي', 'رأس التين', 'بحري', 'المكس', 'القباري', 'كرموز',
  'الورديان', 'الكورنيش', 'محطة الرمل', 'ميامي', 'العصافره', 'سموحه',

  // بورسعيد
  'بورسعيد', 'طرح البحر', 'حي الكويت', 'القناة', 'السوق العمومي', 'الشاطئ', 'الكورنيش', 'ميناء بورسعيد', 'بورفؤاد',

  // باقي المحافظات
  'القليوبية', 'السويس', 'الدقهلية', 'الشرقية', 'الغربية',
  'البحيرة', 'كفر الشيخ', 'دمياط', 'الإسماعيلية',
  'قنا', 'الأقصر', 'أسوان', 'البحر الأحمر', 'الوادي الجديد', 'مطروح', 'شمال سيناء', 'جنوب سيناء'
];
...
const Areas = () => {
  ...
  const regionsByGovernorate = [
    ...
    {
      name: 'الإسكندرية', areas: [
        'الإسكندرية', 'كوم الدكة', 'الشاطبي', 'الأنفوشي', 'رأس التين',
        'بحري', 'المكس', 'القباري', 'كرموز', 'الورديان', 'الكورنيش',
        'محطة الرمل', 'ميامي', 'العصافره', 'سموحه'
      ]
    },
    { name: 'القليوبية', areas: ['شبرا الخيمه', 'القليوبية'] },
    {
      name: 'بورسعيد', areas: [
        'بورسعيد', 'طرح البحر', 'حي الكويت', 'القناة', 'السوق العمومي',
        'الشاطئ', 'الكورنيش', 'ميناء بورسعيد', 'بورفؤاد'
      ]
    },
    ...
    {
      name: 'المنوفية', areas: [
        'المنوفية', 'شبين الكوم', 'منوف', 'مدينة السادات', 'سرس الليان',
        'اشمون', 'الباجور', 'قويسنا', 'بركة السبع', 'تلا'
      ]
    },
    ...
    {
      name: 'الفيوم', areas: [
        'طريق الفيوم', 'الفيوم', 'إبشواي', 'إطسا', 'سنورس', 'طامية', 'يوسف الصديق'
      ]
    },
    {
      name: 'بني سويف', areas: [
    ...
    {
      name: 'المنيا', areas: [
        'المنيا', 'مغاغه', 'بني مزار', 'مطاي', 'سمالوط',
        'ابو قرقاص', 'ملوي', 'دير مواس', 'العدوة'
      ]
    },
    {
      name: 'أسيوط', areas: [
        'أسيوط', 'ديروط', 'القوصيه', 'ابنوب', 'منفلوط',
        'الفتح', 'الغنايم', 'البداري', 'صدفا', 'ساحل سليم', 'ابوتيج'
      ]
    },
    {
      name: 'سوهاج', areas: [
        'سوهاج', 'اخميم', 'ساقلته', 'المراغة', 'طهطا', 'طما',
        'جهينة الغربية', 'المنشأة', 'دار السلام', 'جرجا', 'البلينا'
      ]
    },
    { name: 'قنا', areas: ['قنا'] },
