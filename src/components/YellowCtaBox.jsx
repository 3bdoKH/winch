...
const YellowCtaBox = () => (
  <div style={{
    ...
    <div style={{fontWeight: 'bold', fontSize: '2rem', lineHeight: '1.2', marginBottom: '1.2rem', color: '#212D40'}}>
      اطلب ونش انقاذ سيارات دلوقتي<br />بكل سهولة.
      <div style={{width: '60px', height: '4px', background: '#212D40', borderRadius: '2px', marginTop: '0.5rem', marginRight: 0}}></div>
    </div>
    <div style={{fontSize: '1.1rem', color: '#212D40', fontWeight: 500, lineHeight: '2'}}>
